// ==UserScript==
// @name TSDM 下载区主版tid 适应ES5.1
// @namespace Violentmonkey Scripts
// @grant none
// @include http://www.tsdm.net/forum.php?mod=forumdisplay&fid=*
// @include http://www.tsdm.tw/forum.php?mod=forumdisplay&fid=*
// @include http://www.tsdm.me/forum.php?mod=forumdisplay&fid=*
// @run-at      document-end
// ==/UserScript==
...
(function () {
    ...
    (function () {
        var cssForCheckBox = jQuery("<style>" +
            ...
            "}" +
            "." +
            classNameForCheckBox + ":checked{ background-color: #FF0080;\n            border-color: white;\n            box-shadow: 0px 0px 10px #FF0080; " +
            "}" +
            "</style>");
        var cssForA = jQuery("<style>" +
            "." +
            classNameForA + "{    text-shadow: 0 0 4px #FF0080,0 0 4px #FF0080;\n                color: white !important; " +
            "}" +
            "</style>")
