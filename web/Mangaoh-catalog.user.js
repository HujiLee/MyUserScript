...
// @grant none
// @include     http://www.mangaoh.co.jp/catalog/*
// @run-at      document-end
// ==/UserScript==
...
window.mangaohLog = function(){
    ...
    txtArea.innerHTML="";
    $('.unstyled').has('huji>input[data-sele=1]').each(
        function(){
            writer = $(this).find('small>a:first-of-type')[0].innerHTML;
            bookname = $(this).has('huji>input[data-sele=1]').find('huji+strong>a')[0].innerHTML;
            txtArea.innerHTML+="\n"+writer+" - "+bookname;
